// Implementing composite & iterator pattern page 507
...
//Flock Composite class
class Flock implements Quackable {
  List<Quackable> quackables = [];

  void add(Quackable duck) => quackables.add(duck);

  @override
  void quack() {
    final iterator = quackables.iterator;
...
void main() {
  ...
  final Flock flockOfDucks = Flock();
  ...
  final Flock flockOfMallardDucks = Flock();

  Quackable mallardDuckI = duckFactory.createMallardDuck();
  Quackable mallardDuckII = duckFactory.createMallardDuck();
  Quackable mallardDuckIII = duckFactory.createMallardDuck();
  Quackable mallardDuckIV = duckFactory.createMallardDuck();

  flockOfMallardDucks.add(mallardDuckI);
  flockOfMallardDucks.add(mallardDuckII);
  flockOfMallardDucks.add(mallardDuckIII);
  flockOfMallardDucks.add(mallardDuckIV);
  ...
  print('The Mallard ducks quacked ${QuackCounter.counter.toString()} times');

  simulate(flockOfDucks);
  print('All ducks quacked ${QuackCounter.counter.toString()} times');
}
