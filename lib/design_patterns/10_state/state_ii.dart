...
class GumballMachine {
  ...
  GumballMachine(this.count) {
    soldOutState = SoldOut(gumballMachine: this);
    soldState = Sold(gumballMachine: this);
    noQuarterState = NoQuarter(gumballMachine: this);
    hasQuarterState = HasQuarter(gumballMachine: this);
